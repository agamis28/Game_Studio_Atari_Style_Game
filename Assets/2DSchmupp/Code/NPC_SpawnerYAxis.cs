...
public class NPC_SpawnerYAxis : MonoBehaviour
{
    ...
    public void SpawnNPC() {
        ...
        float yPos = Random.Range(-spawnableWidth, spawnableWidth);
        // Create instance
        // use the current position as the origin, Z is always 0 for 2D
        Vector3 spawnLocation = new Vector3(transform.position.x, transform.position.y + yPos, 0);
